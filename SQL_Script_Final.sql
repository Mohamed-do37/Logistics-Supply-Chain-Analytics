...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Countries.csv'
WITH
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\ShipmentStatusLookup.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\FailureReasonLookup.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\MaterialLookup.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
BULK INSERT Hubs
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Hubs.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Customers.csv'
WITH 
(
    FORMAT = 'CSV',          
    FIELDQUOTE = '"',        
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Couriers.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Employees.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Payments.csv'
WITH 
(
    FIRSTROW = 2, 
    FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\Shipments.csv'
WITH 
(   
	FIELDQUOTE = '"',        
    FIRSTROW = 2, 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\TrackingEvents.csv'
WITH 
(
	FIRSTROW = 2, 
	FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\DeliveryAttempts.csv'
WITH 
(
	FIRSTROW = 2, 
	FIELDTERMINATOR = ',', 
...
FROM 'C:\Users\Admin\Desktop\DataMining_Project_Lab2FF_Group2\SQL\Tables\ProofOfDelivery.csv'
WITH 
(
	FIRSTROW = 2, 
	FIELDTERMINATOR = ',', 
